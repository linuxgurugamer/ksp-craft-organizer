...
namespace KspCraftOrganizer
{
    ...
    public class OrganizerController
    {
        ...
        public void setGroupHasRequireAllFilter(string groupName, bool selectedNone)
        {
            filter.setGroupHasRequireAllFilter(groupName, selectedNone);
        }
