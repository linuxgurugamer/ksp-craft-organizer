...
namespace KspCraftOrganizer
{
    ...
    public class CraftType
    {
        ...
        public static readonly CraftType SUBASSEMBLY = new CraftType("SUBASSEMBLY");
    ...
    public class OrganizerCraftEntity
    {
        ...
        public OrganizerCraftEntity(OrganizerController service, string dirName, bool isDir)
        {
            this.isDir = true;
            _dirName = dirName;
            this.service = service;
        ...
        public string DirName { get { if (isDir) return _dirName; else return ""; } set { isDir = true; _dirName = value; } }
