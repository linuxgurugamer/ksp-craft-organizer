...
namespace KspCraftOrganizer
{
    public class KspAlImpl : IKspAl
    {
        ...
        private List<string> NEW_TAGS_IN_VER3 = new List<string>() { "MasterpieceAmongCrafts" };
            ...
            foreach (ConfigNode part in parts)
            {
                ...
                else
                {
                    ...
                    if (availablePart.partConfig.HasValue("CrewCapacity"))
                        toRet.crewCapacity += int.Parse(availablePart.partConfig.GetValue("CrewCapacity"));
                }
            }
        ...
        private ConfigNode craftDaoDtoToCacheNode(CraftDaoDto craftDaoDto, List<string> partNames, string fileChecksum)
        {
            ...
            toRet.AddValue("crewCapacity", craftDaoDto.crewCapacity);
        ...
        private CraftDaoDto CacheNodeToMaybeCraftDaoDto(CraftDataCacheContext craftDataCacheContext, ConfigNode cacheConfigNode, string expectedChecksum)
        {
            ...
            if (cacheConfigNode.HasValue("crewCapacity"))
                toRet.crewCapacity = int.Parse(cacheConfigNode.GetValue("crewCapacity"));
            else
                toRet.crewCapacity = 0;
        ...
        private void readFilterSettingsToDto(ProfileFilterSettingsDto dto, ConfigNode node, string optionsPrefix)
        {
            ...
            List<string> filterGroupsWithRequireAllOption = readAsListOfStrings(node, optionsPrefix + "filterGroupsWithRequireAllOption");
            ...
            dto.filterGroupsWithRequireAllOption = filterGroupsWithRequireAllOption;
        ...
        private void writeFilterSettingsFromDto(ProfileFilterSettingsDto dto, ConfigNode node, string optionsPrefix)
        {
            ...
            writeAsListOfStrings(node, optionsPrefix + "filterGroupsWithRequireAllOption", dto.filterGroupsWithRequireAllOption);
        ...
        private ICollection<string> getDefaultTags()
        {
            ...
            tags.Add(@"Type\Crewed");
            tags.Add(@"Type\Lander");
            tags.Add(@"Type\Lifters");
            tags.Add(@"Type\LKO");
            tags.Add(@"Type\Orbit");
            tags.Add(@"Type\Satellite");
            tags.Add(@"Type\Spaceplanes");
            tags.Add(@"Type\SpaceStation");
            tags.Add(@"Type\Stock");
            tags.Add(@"Type\Rover");
            tags.Add(@"Type\Unmanned");
